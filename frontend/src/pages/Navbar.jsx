...
const Navbar = ({ user, setUser }) => {
    ...
    flex justify-between px-10 py-4 cursor-pointer">
                ...
                <div className="">
                    <Link to={'/posts'}>
                        <button type="button"  className=" mr-4 focus:outline-none text-white bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 ">POSTS</button>
                    </Link>
                    {user && <Link to={'/posts'}>
